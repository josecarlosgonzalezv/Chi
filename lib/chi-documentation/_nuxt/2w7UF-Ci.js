var D=Object.defineProperty;var T=(i,e,o)=>e in i?D(i,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):i[e]=o;var c=(i,e,o)=>T(i,typeof e!="symbol"?e+"":e,o);import{V as S,N as $}from"./De0T8KV-.js";import{e as V,c as O}from"./CQjlDmeJ.js";import{_ as y}from"./DgLonKwk.js";import{_ as A}from"./BkwV5a8Q.js";import{o as I,h as B,w as l,m as n,b as a,a as t,d as u}from"./XHLcbYGS.js";import{_ as k}from"./DlAUqK2U.js";import"./D4Yj6ayr.js";import"./eT-97QUK.js";import"./LQxRI0Hd.js";var F=Object.defineProperty,H=Object.getOwnPropertyDescriptor,z=(i,e,o,d)=>{for(var s=d>1?void 0:d?H(e,o):e,h=i.length-1,r;h>=0;h--)(r=i[h])&&(s=(d?r(e,o,s):r(s))||s);return d&&s&&F(e,o,s),s};let v=class extends S{constructor(){super(...arguments);c(this,"toolbar",V);c(this,"saveView",O);c(this,"id","base_with_save_view");c(this,"exampleTabs",[{disabled:!0,id:"webcomponent",label:"Web Component"},{active:!0,id:"vue",label:"Vue"},{id:"htmlblueprint",label:"HTML Blueprint"}]);c(this,"codeSnippets",{vue:"",htmlblueprint:""})}created(){this._setCodeSnippets()}_setCodeSnippets(){this.codeSnippets.vue=`<!-- Vue component -->
<ChiDataTableToolbar>
...
<\/script>`}};v=z([$({})],v);const R={class:"chi-form__item"};function P(i,e,o,d,s,h){const r=n("ChiSearchInput"),_=n("ChiDataTableViews"),f=n("ChiDataTableFilters"),m=n("ChiTooltip"),w=n("ChiColumnCustomization"),C=n("ChiDataTableToolbar"),x=n("ChiSaveView"),b=y,g=A;return I(),B(g,{title:"Base with save view",id:i.id,tabs:i.exampleTabs,additionalStyle:"position: static;"},{example:l(()=>[a(C,null,{start:l(()=>[a(r,{dataTableSearch:!0}),e[5]||(e[5]=t("div",{class:"chi-divider -vertical"},null,-1)),a(_,{views:i.toolbar.viewsData},null,8,["views"]),e[6]||(e[6]=t("div",{class:"chi-divider -vertical"},null,-1)),a(f,{class:"-ml--2",filtersData:i.toolbar.filtersData,customItems:i.toolbar.customItemsData},{customAdvanced:l(()=>[t("div",R,[e[3]||(e[3]=t("chi-label",{for:"input-1"},"City",-1)),t("chi-text-input",{id:"input-1","on:chiChange":e[0]||(e[0]=p=>i.inputOneChangeHandler(p))},null,32),e[4]||(e[4]=t("chi-label",{for:"input-2"},"Zip Code",-1)),t("chi-text-input",{id:"input-2","on:chiChange":e[1]||(e[1]=p=>i.inputTwoChangeHandler(p))},null,32)])]),customAdvanced2:l(()=>[t("chi-date-picker",{"on:chiDateChange":e[2]||(e[2]=p=>i.dateChangeHandler(p))},null,32)]),_:1},8,["filtersData","customItems"])]),end:l(()=>[a(m,{message:"Refresh"},{default:l(()=>e[7]||(e[7]=[t("button",{class:"chi-button -icon -flat","aria-label":"Refresh"},[t("div",{class:"chi-button__content"},[t("i",{class:"chi-icon icon-refresh","aria-hidden":"true"})])],-1)])),_:1}),a(m,{message:"Download"},{default:l(()=>e[8]||(e[8]=[t("button",{class:"chi-button -icon -flat","aria-label":"Download"},[t("div",{class:"chi-button__content"},[t("i",{class:"chi-icon icon-arrow-to-bottom","aria-hidden":"true"})])],-1)])),_:1}),a(w,{columnsData:i.toolbar.columnsData},null,8,["columnsData"])]),_:1}),a(x,{config:i.saveView},null,8,["config"])]),"code-vue":l(()=>[e[9]||(e[9]=t("div",{class:"chi-tab__description"},[u("Use the slots "),t("code",null,"start"),u(" to add elements to the left side area of the Toolbar Header and the "),t("code",null,"end"),u(" - to the right side.")],-1)),a(b,{lang:"html",code:i.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":l(()=>[e[10]||(e[10]=t("div",{class:"chi-tab__description"},[u("To render toolbar, use the class "),t("code",null,"chi-toolbar"),u(".")],-1)),a(b,{lang:"html",code:i.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["id","tabs"])}const K=k(v,[["render",P]]);export{K as default};
