import{_ as b}from"./DgLonKwk.js";import{_ as g}from"./BkwV5a8Q.js";import{e as k,j as v,z as y,x as f,o as a,h as w,w as c,a as e,k as o,c as r,l as d,d as m,b as h}from"./XHLcbYGS.js";import{generateAllExampleFooters as x,generateExampleFooter as B}from"./C4ANiZXI.js";const P={backlink:"Back link",title:"Page title",subtitle:"Page subtitle"},T={slot:"footer"},$=["innerHTML"],E=["innerHTML"],L=["innerHTML"],s="back-link-subtitle-buttons-language-dropdown-button",V=k({__name:"_back_link_subtitle_buttons",setup(M){const t=v(),l=x(s);y(()=>{const n=document.getElementById(s);n&&chi.dropdown(n)});const u=f(()=>{const n=B(t,s);return{webcomponent:`<chi-main backlink="Back link" title="Page title" subtitle="Page subtitle">
