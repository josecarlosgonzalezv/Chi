import{_ as u}from"./DgLonKwk.js";import{_ as g}from"./BkwV5a8Q.js";import{e as v,j as f,z as b,x as T,o as c,h as w,w as s,a as n,k as i,c as r,l as d,b as _}from"./XHLcbYGS.js";import{generateAllExampleFooters as y,generateExampleFooter as k}from"./C4ANiZXI.js";const x={title:"Page Title"},B={slot:"footer"},$=["innerHTML"],E=["innerHTML"],L=["innerHTML"],o="alert-language-dropdown-button",N=v({__name:"_alert",setup(M){const e=f(),a=y(o);b(()=>{const t=document.getElementById(o);t&&chi.dropdown(t)});const m=T(()=>{const t=k(e,o);return{webcomponent:`<chi-main title="Page Title">
