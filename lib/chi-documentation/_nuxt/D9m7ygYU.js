import{_ as k}from"./DgLonKwk.js";import{_ as g}from"./BkwV5a8Q.js";import{e as v,j as b,z as f,x as y,o as a,h as w,w as s,a as i,k as n,c as d,l as r,d as h,b as _}from"./XHLcbYGS.js";import{generateAllExampleFooters as x,generateExampleFooter as B}from"./C4ANiZXI.js";const T={backlink:"Back link",title:"Page title"},$={slot:"footer"},E=["innerHTML"],L=["innerHTML"],M=["innerHTML"],o="back-link-language-dropdown-button",V=v({__name:"_back_link",setup(H){const e=b(),l=x(o);f(()=>{const t=document.getElementById(o);t&&chi.dropdown(t)});const m=y(()=>{const t=B(e,o);return{webcomponent:`<chi-main backlink="Back link" title="Page title">
