import{_ as g}from"./DgLonKwk.js";import{_ as f}from"./BkwV5a8Q.js";import{e as b,f as x,j as y,z as w,x as k,o as l,h as E,w as r,a as e,k as n,c as s,l as p,b as m}from"./XHLcbYGS.js";import{generateAllExampleFooters as P,generateExampleFooter as T}from"./C4ANiZXI.js";const B={title:"Page title"},H={slot:"help-icon"},L={ref:"popover",position:"right-start",variant:"text",arrow:"",reference:"#help-icon__help-button"},$={slot:"footer"},M=["innerHTML"],C=["innerHTML"],q=["innerHTML"],i="help-icon-language-dropdown-button",j=b({__name:"_help_icon",setup(I){const _=x("popover"),t=y(),a=P(i);w(()=>{const o=document.getElementById(i);o&&chi.dropdown(o)});const u=()=>{_.value.toggle()},d=k(()=>{const o=T(t,i);return{webcomponent:`<chi-main title="Page title">
