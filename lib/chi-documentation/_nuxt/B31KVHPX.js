import{_ as k}from"./DgLonKwk.js";import{_ as w}from"./BkwV5a8Q.js";import{e as f,j as u,f as x,z as W,x as b,o as a,h as C,w as h,a as i,k as s,c as o,l as n,b as _}from"./XHLcbYGS.js";import{generateAllExampleFooters as V,generateExampleFooter as L}from"./C4ANiZXI.js";const z={title:"Page Title",format:"fixed-width","header-background":""},y={slot:"help-icon"},T={ref:"popover",position:"right-start",variant:"text",arrow:"",reference:"#dashboard-alert__help-button"},B={slot:"footer"},E=["innerHTML"],H=["innerHTML"],$=["innerHTML"],d="dashboard-alert-language-dropdown-button",N=f({__name:"_dashboard_alert",setup(M){const c=u(),t=V(d),g=x("popover");W(()=>{const l=document.getElementById(d);l&&chi.dropdown(l)});const m=()=>{g.value.toggle()},r=b(()=>{const l=L(c,d);return{webcomponent:`<chi-main title="Page Title" format="fixed-width" header-background>
