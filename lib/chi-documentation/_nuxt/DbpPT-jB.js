...
</div>`}})})],r);const C={class:"chi-card -portal -bg--white"},L={class:"chi-card__content -p--0"};function P(e,a,s,d,i,c){const l=N("ChiDataTable"),v=h,b=u;return g(),f(b,{title:"State",id:"state-data-table",tabs:e.exampleTabs},{example:n(()=>[t("div",C,[a[0]||(a[0]=t("div",{class:"chi-card__header -sm"},[t("div",{class:"chi-card__title"},"Title")],-1)),t("div",L,[o(l,{config:e.config,dataTableData:e.table},null,8,["config","dataTableData"])])])]),"code-vue":n(()=>[a[1]||(a[1]=t("div",{class:"chi-tab__description"},[m("Use "),t("code",null,"state"),m(" config to achieve state styling")],-1)),o(v,{lang:"html",code:e.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":n(()=>[o(v,{lang:"html",code:e.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const I=D(r,[["render",P]]);export{I as default};
