import{_ as u}from"./DgLonKwk.js";import{_ as h}from"./BkwV5a8Q.js";import{e as g,o as a,h as v,w as r,a as c,c as o,i as x,n as p,t as b,F as f,b as $}from"./XHLcbYGS.js";const N={class:"-p--3"},w={class:"chi-badge__content"},k=["innerHTML"],L=g({__name:"_applicationState",setup(B){const m=[{active:!0,id:"htmlblueprint",label:"HTML Blueprint"}],l=[{icon:"icon-circle",text:"Running",className:"success"},{svgIcon:`<svg class="chi-spinner -sm" viewBox="0 0 66 66">
      <title>Loading</title>
