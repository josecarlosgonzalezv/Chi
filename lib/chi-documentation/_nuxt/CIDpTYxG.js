import{_}from"./DgLonKwk.js";import{_ as g}from"./BkwV5a8Q.js";import{e as f,o as a,h as v,w as n,a as t,c as r,i as m,F as c,n as C,t as x,b as y}from"./XHLcbYGS.js";const B={class:"-p--1"},$={class:"chi-table -bordered"},P=f({__name:"_table-cell",setup(q){const u=[{active:!0,id:"htmlblueprint",label:"HTML Blueprint"}],i=[1,2,3,4,5],o=["baseline","top","middle","bottom"],d=()=>o.map(l=>`      <td class="-vertical-align--${l}">${l}</td>`).join(`
