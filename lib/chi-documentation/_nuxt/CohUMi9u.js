...
</div>`}})})],s);function A(a,t,l,i,e,d){const n=N("ChiDataTable"),r=_,m=h;return f(),g(m,{title:"Accordion",id:"accordion-data-table",tabs:a.exampleTabs},{example:c(()=>[o(n,{config:a.config,dataTableData:a.table},null,8,["config","dataTableData"])]),"code-vue":c(()=>[t[0]||(t[0]=v("div",{class:"chi-tab__description"},[b("Use "),v("code",null,"nestedContent"),b(" property to provide data for the accordion content.")],-1)),o(r,{lang:"html",code:a.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":c(()=>[o(r,{lang:"html",code:a.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const I=D(s,[["render",A]]);export{I as default};
