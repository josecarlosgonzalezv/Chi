...
</div>`}})})],o);function C(a,i,d,t,e,s){const l=N("ChiDataTable"),v=h,p=u;return f(),g(p,{title:"Active",id:"active-data-table",tabs:a.exampleTabs},{example:c(()=>[n(l,{config:a.config,dataTableData:a.table},null,8,["config","dataTableData"])]),"code-vue":c(()=>[i[0]||(i[0]=m("div",{class:"chi-tab__description"},[r("Use "),m("code",null,"active"),r(" property to achieve active state of rows")],-1)),n(v,{lang:"html",code:a.codeSnippets.vue},null,8,["code"])]),"code-htmlblueprint":c(()=>[n(v,{lang:"html",code:a.codeSnippets.htmlblueprint},null,8,["code"])]),_:1},8,["tabs"])}const $=D(o,[["render",C]]);export{$ as default};
