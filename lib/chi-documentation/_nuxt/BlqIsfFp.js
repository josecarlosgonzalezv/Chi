...
</div>`}],exampleTabs:[{active:!1,id:"webcomponent",label:"Web Component",disabled:!0},{active:!0,id:"vue",label:"Vue"},{active:!1,id:"htmlblueprint",label:"HTML Blueprint"}],config:{columnResize:!0,style:{portal:!0,noBorder:!1,bordered:!1,hover:!1,size:"md",striped:!0},pagination:{activePage:1,compact:!0,firstLast:!0,pageJumper:!1},showExpandAll:!0,resultsPerPage:3}})})],r);const E={class:"chi-card -portal -bg--white"},T={class:"chi-card__content -p--0"};function P(l,a,s,i,e,n){const t=g("ChiDataTable"),m=w,_=N;return b(!0),D(C,null,x(l.accordionTypes,c=>(b(),L(_,{title:c.title,id:c.id,tabs:l.exampleTabs},{example:o(()=>[d("div",E,[a[0]||(a[0]=d("div",{class:"chi-card__header -sm"},[d("div",{class:"chi-card__title"},"Title")],-1)),d("div",T,[v(t,{config:l.config,dataTableData:c.table},null,8,["config","dataTableData"])])])]),"code-vue":o(()=>[a[1]||(a[1]=d("div",{class:"chi-tab__description"},[h("Use "),d("code",null,"nestedContent"),h(" property to provide data of row accordion content")],-1)),v(m,{lang:"html",code:c.codeSnippetVue},null,8,["code"])]),"code-htmlblueprint":o(()=>[v(m,{lang:"html",code:c.codeSnippetHtml},null,8,["code"])]),_:2},1032,["title","id","tabs"]))),256)}const S=y(r,[["render",P]]);export{S as default};
