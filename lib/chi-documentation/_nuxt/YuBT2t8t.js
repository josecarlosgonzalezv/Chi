import{_ as k}from"./DgLonKwk.js";import{_ as w}from"./BkwV5a8Q.js";import{e as u,j as f,f as x,z as W,x as b,o as a,h as C,w as h,a as i,k as e,c as o,l as n,b as _}from"./XHLcbYGS.js";import{generateAllExampleFooters as V,generateExampleFooter as L}from"./C4ANiZXI.js";const z={title:"Page title",format:"fixed-width","header-background":""},y={slot:"help-icon"},B={ref:"popover",position:"right-start",variant:"text",arrow:"",reference:"#dashboard__help-button"},E={slot:"footer"},T=["innerHTML"],H=["innerHTML"],$=["innerHTML"],d="dashboard-language-dropdown-button",N=u({__name:"_dashboard",setup(M){const c=f(),t=V(d),g=x("popover");W(()=>{const s=document.getElementById(d);s&&chi.dropdown(s)});const m=()=>{g.value.toggle()},r=b(()=>{const s=L(c,d);return{webcomponent:`<chi-main title="Page title" format="fixed-width" header-background>
...
<script>${c==="centurylink"?"":`
  chi.dropdown(document.getElementById('${d}'));`}
