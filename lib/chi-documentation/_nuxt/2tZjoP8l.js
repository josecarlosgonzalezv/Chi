...
}`}})})],u);const $={class:"-text--truncate",style:{"padding-left":"0.5rem"}},z={class:"-d--flex -no-gutter -bt--1"},B={class:"-flex--grow1"},L={class:"chi-tabs-panel -active",id:"vertical-base-1",role:"tabpanel"},S={class:"chi-tabs-panel",id:"vertical-base-2",role:"tabpanel"},A={class:"chi-tabs-panel",id:"vertical-base-3",role:"tabpanel"};function H(t,e,s,o,l,c){const r=m("ChiPopoverExample"),h=m("ChiDropdownExample"),g=m("ChiDataTableToolbar"),b=m("ChiDataTable"),p=N,y=f;return x(),O(y,{title:"Complex",id:"complex-data-table",tabs:t.exampleTabs},{example:i(()=>[d(b,{config:t.config,dataTableData:t.table,ref:"dataTableComplex"},{status:i(n=>[a("i",{class:G(`chi-icon icon-${n.icon} -icon--${n.color}`),"aria-hidden":"true"},null,2),a("span",$,_(n.status),1)]),name:i(n=>[d(r,{name:n.name,id:n.id},null,8,["name","id"])]),actions:i(n=>[d(h,{id:n.id},null,8,["id"])]),toolbar:i(()=>[d(g,null,{end:i(()=>[a("chi-button",{onClick:e[0]||(e[0]=(...n)=>t.printTable&&t.printTable(...n)),variant:"flat",type:"icon","aria-label":"Print data table complex example"},e[1]||(e[1]=[a("chi-icon",{icon:"print"},null,-1)]))]),_:1})]),"bulk-actions":i(()=>e[2]||(e[2]=[a("div",{class:"chi-bulk-actions__buttons"},[a("div",{class:"chi-bulk-actions__buttons-mobile -z--40"},[a("chi-button",{variant:"flat",type:"icon","aria-label":"Edit"},[a("chi-icon",{icon:"edit"})]),a("chi-button",{variant:"flat",type:"icon","aria-label":"Compose"},[a("chi-icon",{icon:"compose"})]),a("chi-button",{variant:"flat",type:"icon","aria-label":"Delete"},[a("chi-icon",{icon:"delete"})]),a("chi-button",{variant:"flat",type:"icon","aria-label":"Print"},[a("chi-icon",{icon:"print"})])]),a("div",{class:"chi-bulk-actions__buttons-desktop"},[a("chi-button",{size:"xs","aria-label":"Download"},[a("chi-icon",{icon:"arrow-to-bottom"}),a("span",null,"Download")]),a("chi-button",{size:"xs","aria-label":"Compose"},[a("chi-icon",{icon:"arrow-to-bottom"}),a("span",null,"Compose")]),a("chi-button",{size:"xs","aria-label":"Delete"},[a("chi-icon",{icon:"arrow-to-bottom"}),a("span",null,"Delete")]),a("chi-button",{size:"xs","aria-label":"Print"},[a("chi-icon",{icon:"arrow-to-bottom"}),a("span",null,"Print")])])],-1)])),_:1},8,["config","dataTableData"])]),"code-vue":i(()=>[e[4]||(e[4]=a("div",{class:"chi-tab__description -p--2"},"Create reusable Vue components based on your needs and use them as custom templates for Data Table cells and row accordions",-1)),a("div",z,[e[3]||(e[3]=a("div",{class:"-bg--grey-15 -pt--3 -br--1",style:{width:"14rem"}},[a("ul",{class:"chi-tabs -vertical",id:"example-vertical-base",role:"tablist","aria-label":"chi-tabs-vertical-base"},[a("li",{class:"-active"},[a("a",{href:"#vertical-base-1",role:"tab","aria-selected":"true","aria-controls":"vertical-base-1"},"ExampleDataTable.vue")]),a("li",null,[a("a",{href:"#vertical-base-2",role:"tab","aria-selected":"false",tabindex:"-1","aria-controls":"vertical-base-2"},"ExamplePopover.vue")]),a("li",null,[a("a",{href:"#vertical-base-3",role:"tab","aria-selected":"false",tabindex:"-1","aria-controls":"vertical-base-3"},"ExampleDropdown.vue")]),a("li",{class:"chi-sliding-border"})])],-1)),a("div",B,[a("div",L,[d(p,{lang:"html",code:t.codeSnippets.dataTableExample},null,8,["code"])]),a("div",S,[d(p,{lang:"html",code:t.codeSnippets.popoverExample},null,8,["code"])]),a("div",A,[d(p,{lang:"html",code:t.codeSnippets.dropdownExample},null,8,["code"])])])])]),_:1},8,["tabs"])}const F=T(u,[["render",H]]);export{F as default};
